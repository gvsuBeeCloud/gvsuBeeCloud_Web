...
<script type="text/javascript"
    ...
    <form action='/uploadHive' method="post">
    	...
    	<label class='lbl_upload'>Temperature:</label><input name='temperature' class='in_upload' type='text' />
    	<label class='lbl_upload'>Weight:</label><input name='weight' class='in_upload' type='text' />
